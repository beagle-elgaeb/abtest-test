...
_[Фигма-макет, где нужно взять UI-элементы](https://www.figma.com/file/QiNnIWCBeOGxhmrXN2UILQ/%D0%B8%D0%BD%D1%82%D0%B5%D1%80%D1%84%D0%B5%D0%B9%D1%81-Copy?node-id=0%3A1 "Ссылка на Фигму")_
...
- выполняется базовая валидация: кнопки неактивны, если есть незаполненные строки, незаполненные строки подсвечены;
- приложение задеплоено;
- страница адаптируется в пределах 700-1334px;

## Возможные улучшения

- Разделить компонент Calculator на меньшие компоненты;
- кнопки удаления лишних строк;
- сделать покрасивее гистограмму.
